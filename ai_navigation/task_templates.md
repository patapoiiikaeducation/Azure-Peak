...
- Check whether modular extends the same path.
...
- Runtime owner: <if known; e.g. SSskills, SSmigrants, SSmapping>
- Usage surface:
...
- Check whether the change belongs in core code or in modular.
...
- Check both core and modular before adding a duplicate branch.
