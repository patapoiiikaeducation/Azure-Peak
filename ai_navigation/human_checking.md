...
- `high risk`: ask for approval before editing and state the likely blast radius and server-cost risks; if the change creates or destroys objects, verify `ai_navigation/coding_standards.md` Section GC contract before writing code
