...
#define TRAIT_DAWNWALKER "Dawnwalker"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_DAWNWALKER = span_warning("I walk as a living dhampir. Silver saps my strength, miracles burn or fail me, and my thirst for blood keeps the sun at bay."),
